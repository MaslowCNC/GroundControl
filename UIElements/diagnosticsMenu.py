...
class Diagnostics(FloatLayout, MakesmithInitFuncs):
    ...
    def testFeedbackSystem(self):
        ...
        self.data.message_queue.put("Message: If you press \"Continue\" Maslow will run a small test shape and report the average positional error to test the feedback control system. The z-axis will not move during this cut")
        self.parentWidget.close()