...
class BackgroundSettingsDlg(GridLayout, MakesmithInitFuncs):
    ...
    backgroundTRCENT = StringProperty("(0, 0)")
    backgroundTLCENT = StringProperty("(100, 0)")
    backgroundBLCENT = StringProperty("(0, 100)")
    backgroundBRCENT = StringProperty("(100, 100)")
    ...
    def __init__(self, data, **kwargs):
        ...
        self.backgroundTRCENT = json.dumps(self.data.backgroundTRCENT)
        self.backgroundTLCENT = json.dumps(self.data.backgroundTLCENT)
        self.backgroundBLCENT = json.dumps(self.data.backgroundBLCENT)
        self.backgroundBRCENT = json.dumps(self.data.backgroundBRCENT)
        #Convert to JSON data so caller can get tuples back
        self.backgroundTLHSV = json.dumps(self.data.backgroundTLHSV)
        self.backgroundTRHSV = json.dumps(self.data.backgroundTRHSV)
        self.backgroundBLHSV = json.dumps(self.data.backgroundBLHSV)
    ...
    def closeit(self):
        ...
        self.backgroundTRCENT = self.trcent.text
        self.backgroundTLCENT = self.tlcent.text
        self.backgroundBLCENT = self.blcent.text
        self.backgroundBRCENT = self.brcent.text
